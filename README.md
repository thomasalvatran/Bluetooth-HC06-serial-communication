...
Basically it replaces the RS-232 serial port(UART) cable by going into the air using Bluetooth. It has the same interface as serial port: 5 v, GND, TxD and RxD. The code is using <b>Radio Frequency Communications (RFCOMM) protocol is a reliable
